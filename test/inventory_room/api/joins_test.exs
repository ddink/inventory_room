defmodule InventoryRoom.API.JoinsTest do
  use InventoryRoom.DataCase, async: true
  alias Ecto.Changeset
	import InventoryRoom.API.Joins
  ...
  describe "create_product_option_type/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %ProductOptionType{} = returned_schema} = 
        create_product_option_type(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_product_option_type(bad_params)
    end
  end
  ...
  describe "create_product_property/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %ProductProperty{} = returned_schema} = 
        create_product_property(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_product_property(bad_params)
    end
  end
  ...
  describe "create_product_taxon/1" do
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_product_taxon(bad_params)
    end
  end
  ...
  describe "create_shipping_method_category/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %ShippingMethodCategory{} = returned_schema} = 
        create_shipping_method_category(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_shipping_method_category(bad_params)
    end
  end
  ...
  describe "create_shipping_method_stock_location/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %ShippingMethodStockLocation{} = returned_schema} = 
        create_shipping_method_stock_location(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_shipping_method_stock_location(bad_params)
    end
  end
  ...
  describe "create_shipping_method_zone/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %ShippingMethodZone{} = returned_schema} = 
        create_shipping_method_zone(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_shipping_method_zone(bad_params)
    end
  end
  ...
  describe "create_store_payment_method/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %StorePaymentMethod{} = returned_schema} = 
        create_store_payment_method(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_store_payment_method(bad_params)
    end
  end
  ...
  describe "create_variant_option_value/1" do
    test "success: it inserts a schema in the db and returns the schema" do
      ...
      assert {:ok, %VariantOptionValue{} = returned_schema} = 
        create_variant_option_value(params)
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_variant_option_value(bad_params)
    end
  end
  ...
  describe "create_zone_member/1" do
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = create_zone_member(bad_params)
    end
  end
  ...
  describe "get_product_option_type/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ProductOptionType{} = returned_schema = get_product_option_type(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_product_option_type(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_product_property/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ProductProperty{} = returned_schema = get_product_property(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_product_property(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_product_taxon/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ProductTaxon{} = returned_schema = get_product_taxon(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_product_taxon(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_shipping_method_category/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ShippingMethodCategory{} = returned_schema = get_shipping_method_category(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_shipping_method_category(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_shipping_method_stock_location/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ShippingMethodStockLocation{} = returned_schema = get_shipping_method_stock_location(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_shipping_method_stock_location(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_shipping_method_zone/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ShippingMethodZone{} = returned_schema = get_shipping_method_zone(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_shipping_method_zone(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_store_payment_method/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %StorePaymentMethod{} = returned_schema = get_store_payment_method(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_store_payment_method(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_variant_option_value/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %VariantOptionValue{} = returned_schema = get_variant_option_value(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_variant_option_value(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_zone_member/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %ZoneMember{} = returned_schema = get_zone_member(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert get_zone_member(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "update_product_option_type/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ProductOptionType{} = returned_schema} = update_product_option_type(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_product_option_type(existing_schema, bad_params)
  ...
  describe "update_product_property/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ProductProperty{} = returned_schema} = update_product_property(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_product_property(existing_schema, bad_params)
  ...
  describe "update_product_taxon/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ProductTaxon{} = returned_schema} = update_product_taxon(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_product_taxon(existing_schema, bad_params)
  ...
  describe "update_shipping_method_category/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ShippingMethodCategory{} = returned_schema} = update_shipping_method_category(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_shipping_method_category(existing_schema, bad_params)
  ...
  describe "update_shipping_method_stock_location/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ShippingMethodStockLocation{} = returned_schema} = update_shipping_method_stock_location(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_shipping_method_stock_location(existing_schema, bad_params)
  ...
  describe "update_shipping_method_zone/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ShippingMethodZone{} = returned_schema} = update_shipping_method_zone(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_shipping_method_zone(existing_schema, bad_params)
  ...
  describe "update_store_payment_method/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %StorePaymentMethod{} = returned_schema} = update_store_payment_method(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_store_payment_method(existing_schema, bad_params)
  ...
  describe "update_variant_option_value/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %VariantOptionValue{} = returned_schema} = update_variant_option_value(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_variant_option_value(existing_schema, bad_params)
  ...
  describe "update_zone_member/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %ZoneMember{} = returned_schema} = update_zone_member(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               update_zone_member(existing_schema, bad_params)
  ...
  describe "delete_product_option_type/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_product_option_type(schema)
  ...
  describe "delete_product_property/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_product_property(schema)
  ...
  describe "delete_product_taxon/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_product_taxon(schema)
  ...
  describe "delete_shipping_method_category/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_shipping_method_category(schema)
  ...
  describe "delete_shipping_method_stock_location/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_shipping_method_stock_location(schema)
  ...
  describe "delete_shipping_method_zone/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_shipping_method_zone(schema)
  ...
  describe "delete_store_payment_method/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_store_payment_method(schema)
  ...
  describe "delete_variant_option_value/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_variant_option_value(schema)
  ...
  describe "delete_zone_member/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = delete_zone_member(schema)
