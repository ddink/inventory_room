defmodule InventoryRoom.Inventory.StockItemTest do
  use InventoryRoom.DataCase, async: true
  alias Ecto.Changeset
  import InventoryRoom.Inventory.StockItem

  describe "changeset/1" do
    test "success: returns a valid changeset when given valid arguments" do
      params = Factory.string_params_for(:stock_item)
      ...
      for field <- stock_item_fields() do
