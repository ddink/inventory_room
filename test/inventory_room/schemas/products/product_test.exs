defmodule InventoryRoom.Products.ProductTest do
  use InventoryRoom.DataCase, async: true
  alias Ecto.Changeset
  import InventoryRoom.Products.Product
  
  describe "changeset/1" do
    test "success: returns a valid changeset when given valid arguments" do
      params = Factory.string_params_for(:product)

      assert_valid_changeset(params, product_fields(), &changeset/1)
    end

    test "error: returns an error changeset when given un-castable values" do
      params = bad_product_params()
  ...
  describe "create_changeset/1" do
    test "success: returns a valid changeset when given valid arguments" do
      ...
      assert_valid_changeset(params, product_fields(), &create_changeset/1)
    end
