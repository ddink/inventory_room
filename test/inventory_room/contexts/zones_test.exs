defmodule InventoryRoom.Contexts.ZonesTest do
  ...
  describe "create_country/1" do
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = Zones.create_country(bad_params)
    end
  end
  ...
  describe "create_state/1" do
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = Zones.create_state(bad_params)
    end
  end
  ...
  describe "create_zone/1" do
    ...
    test "error: returns an error tuple when user can't be created" do
      ...
      assert {:error, %Changeset{valid?: false}} = Zones.create_zone(bad_params)
    end
  end
  ...
  describe "get_country/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %Country{} = returned_schema = Zones.get_country(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert Zones.get_country(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_state/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %State{} = returned_schema = Zones.get_state(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert Zones.get_state(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "get_zone/1" do
    test "success: it returns a schema when given a valid UUID" do
      ...
      assert %Zone{} = returned_schema = Zones.get_zone(existing_schema.id)

      assert returned_schema == existing_schema
    end

    test "error: it returns nil when a schema doesn't exist" do
      assert Zones.get_zone(Enum.random(1..1000)) == nil
    end
  end
  ...
  describe "update_country/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %Country{} = returned_schema} = Zones.update_country(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               Zones.update_country(existing_schema, bad_params)
  ...
  describe "update_state/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %State{} = returned_schema} = Zones.update_state(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               Zones.update_state(existing_schema, bad_params)
  ...
  describe "update_zone/2" do
    test "success: it updates database and returns the schema" do
      ...
      assert {:ok, %Zone{} = returned_schema} = Zones.update_zone(existing_schema, params)
    ...
    test "error: returns an error tuple when cart can't be updated" do
      ...
      assert {:error, %Changeset{valid?: false, errors: _errors}} =
               Zones.update_zone(existing_schema, bad_params)
  ...
  describe "delete_country/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = Zones.delete_country(schema)
  ...
  describe "delete_state/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = Zones.delete_state(schema)
  ...
  describe "delete_zone/1" do
    test "success: it deletes the schema" do
      ...
      assert {:ok, _deleted_schema} = Zones.delete_zone(schema)
